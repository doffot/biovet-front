          ...
          {fields.map((field, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pr-8">
                ...
                <div>
                  <label className="label text-[10px]">
                    Presentación <span className="text-danger-500">*</span>
                  </label>
                  <input
                    {...register(`medications.${index}.presentation`, {
                      required: "Requerido",
                    })}
                    className="input text-sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  <label className="label text-[10px]">
                    Origen <span className="text-danger-500">*</span>
                  </label>
                  <select
                    {...register(`medications.${index}.source`, {
                      required: "Requerido",
                    })}
