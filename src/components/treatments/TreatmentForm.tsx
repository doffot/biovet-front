    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <div>
          ...
          {errors.treatmentType && (
            <p className="error-text">{errors.treatmentType.message}</p>
          )}
        </div>
        ...
        {typeValue === "Otro" && (
          <div className="md:col-span-2 animate-fade-in">
            <label className="label">
              Especifique Tipo <span className="text-danger-500">*</span>
            </label>
            <input
              {...register("treatmentTypeOther", {
                required: "Debes especificar el tipo personalizado",
            ...
            />
            {errors.treatmentTypeOther && (
              <p className="error-text">{errors.treatmentTypeOther.message}</p>
            )}
          </div>
        )}
        ...
        <div>
          <label className="label">
            Vía de Administración <span className="text-danger-500">*</span>
          </label>
          <select
          ...
          {errors.route && (
            <p className="error-text">{errors.route.message}</p>
          )}
        </div>
        ...
        {routeValue === "Otro" && (
          <div className="animate-fade-in">
            <label className="label">
              Especifique Vía <span className="text-danger-500">*</span>
            </label>
            <input
              {...register("routeOther", {
                required: "Debes especificar la vía personalizada",
                setValueAs: (v: string) => v?.trim() || undefined,
                minLength: {
                  value: 2,
                  message: "Mínimo 2 caracteres",
            ...
            />
            {errors.routeOther && (
              <p className="error-text">{errors.routeOther.message}</p>
            )}
          </div>
        )}
      </div>
      ...
      <div className="p-4 bg-surface-50 dark:bg-dark-100 rounded-xl border border-surface-200 dark:border-dark-50 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="label">
              Dosis <span className="text-danger-500">*</span>
            </label>
            <input
            ...
            />
            {errors.dose && (
              <p className="error-text">{errors.dose.message}</p>
            )}
          </div>

          <div>
            <label className="label">
              Frecuencia <span className="text-danger-500">*</span>
            </label>
            <input
            ...
            />
            {errors.frequency && (
              <p className="error-text">{errors.frequency.message}</p>
            )}
          </div>
      ...
      <div>
        <label className="label">
          Estado del Tratamiento <span className="text-danger-500">*</span>
        </label>
