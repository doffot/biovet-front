  ...
  return (
    ...
    ">
      ...
      <div className="flex items-center gap-2">
        <button className="hidden sm:flex btn-icon-mobile dark:bg-dark-100 dark:text-slate-400 dark:border-slate-700">
          <Calendar size={20} />
        </button>
        
        <button className="btn-icon-mobile relative dark:bg-dark-100 dark:text-slate-400 dark:border-slate-700">
