// src/views/sales/components/SalesHeader.tsx
...
export function SalesHeader({ totalCount, onBack, onNewSale }: SalesHeaderProps) {
  return (
    <>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            ...
            <p className="text-[13px] text-biovet-500 font-medium">{totalCount}</p>
          </div>
        </div>
